                ...
                <Stack.Screen options={{
                     headerBackground: () => (
                        <Image
                            ...
                            source={(require('../Base PROJETO SENAI/res/img/BOOKFLOW/HEADERBookFlow.png'))}
                        />
                    ),
                    title: '',
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: 'red' }, headerTintColor: 'red',}} name="Homesenai" component={Homesenai} />
                <Stack.Screen options={{
                     headerBackground: () => (
                        <Image
                            style={{ width: '100%', height: '100%' }}
                            source={(require('../Base PROJETO SENAI/res/img/HEADERBookFlow.png'))}
                        />
                    ),
                    title: '',
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: 'red' }, headerTintColor: 'red',}} name="CadastroBook" component={CadastroBook} />
                <Stack.Screen options={{
                     headerBackground: () => (
                        <Image
                            style={{ width: '100%', height: '100%' }}
                    ...
                    title: '',
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: 'red' }, headerTintColor: 'red',}} name="BookPrincipal" component={HomePage} />
                <Stack.Screen options={{
                     headerBackground: () => (
                        <Image
                            style={{ width: '100%', height: '100%' }}
                    ...
                    title: '',
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: 'red' }, headerTintColor: 'white',}} name="Config" component={Config} />
                <Stack.Screen options={{
                      headerBackground: () => (
                        <Image
                            style={{ width: '100%', height: '100%' }}
                            source={(require('../Base PROJETO SENAI/res/img/BOOKFLOW/sobreText.png'))}
                        />
                    ),
                    title: '',
                   
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: '#A70A0A' }, headerTintColor: 'red',}} name="TelaSobre" component={TelaSobre} />
                <Stack.Screen options={{
                      headerBackground: () => (
                        <Image
                            style={{ width: '100%', height: '100%' }}
                    ...
                    title: '',
                    headerTitleAlign: 'center',
                    headerStyle: { backgroundColor: '#A70A0A' }, headerTintColor: 'red',}} name="editarPerfil" component={editarPerfil} />
