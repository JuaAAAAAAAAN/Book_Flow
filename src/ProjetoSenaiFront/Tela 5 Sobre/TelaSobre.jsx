        ...
        <SafeAreaView>
            ...
            <ImageBackground style={{ width: 412, height: 730, }} source={require('../../../res/img/BOOKFLOW/WallpaperSobre.png')} >
                    ...
                    <View style={{ width: '90%', alignSelf:'center', justifyContent: 'center'}}>
                        ...
                        Este aplicativo facilita a troca de livros físicos entre usuários e ajuda a conectar amantes de leitura. Você pode cadastrar os livros que deseja trocar, procurar e filtrar outros livros disponíveis, negociar trocas através de mensagens, e agendar encontros ou envios. Além disso, pode avaliar suas experiências e interagir com a comunidade de leitores, tornando a troca de livros simples e prazerosa.
                        </Text>
